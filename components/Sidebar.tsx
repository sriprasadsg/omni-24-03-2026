    ...
    const navGroups: NavGroup[] = useMemo(() => [
        ...
        },
        {
            ...
            items: [
                ...
                { view: 'itam', label: 'IT Asset Management', icon: <HardDriveIcon size={20} />, permission: 'manage:itam' },
                ...
                { view: 'stagedDeployments', label: 'Staged Deployments', icon: <BoxIcon size={20} />, permission: 'view:software_deployment' },
        ...
        },
        {
            ...
            items: [
                ...
                { view: 'cloudChecksScanner', label: 'Cloud Checks Scanner', icon: <CloudShieldIcon size={20} />, permission: 'view:cloud_security' },
