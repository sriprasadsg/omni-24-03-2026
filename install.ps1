...
try {
    ...
    Write-Warning "Failed to register service (likely due to insufficient permissions): $_"
    ...
    Write-Host "Agent started as a standalone process. (Note: It will stop if you reboot)" -ForegroundColor Yellow
    
    # Skip Start-Service below
    exit 0
}
