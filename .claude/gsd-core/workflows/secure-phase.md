...
```
Agent(
  prompt="Read /home/user/enterprise-omni-agent-ai-platform/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/templates/SECURITY.md`
