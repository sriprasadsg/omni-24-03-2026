...
INSTALL_JS_GLOBAL="/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
