...
```markdown
Read /home/user/enterprise-omni-agent-ai-platform/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/enterprise-omni-agent-ai-platform/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/user/enterprise-omni-agent-ai-platform/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/user/enterprise-omni-agent-ai-platform/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
