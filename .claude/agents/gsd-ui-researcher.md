...
Use template from `/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/templates/UI-SPEC.md`
