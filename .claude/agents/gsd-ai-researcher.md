...
<required_reading>
Read `/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
