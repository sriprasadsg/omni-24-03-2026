...
**Verification depth scales with `asvs_level`** (see @/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
