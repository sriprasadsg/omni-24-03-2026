...
<reference>
@/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/references/user-profiling.md` to load:
