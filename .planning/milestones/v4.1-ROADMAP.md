...
- **v4.1** — ITAM-Backlog: gap-closure work promoted from the v4.1 backlog track (superseded 2026-08-13, folded into this file as Phases 69–73) — user management (LDAP/SAML/2FA/API tokens), custom fields/audit trail/CSV import-export/global settings, procurement & asset workflow, reporting & dashboards, REST API & integrations. 5 phases (69–73), ITAM-USR/DAT/SET/PRO/REP/API requirements. Code complete — pending REQUIREMENTS.md sync (ITAM-PRO-04/05 rows stale) and a retroactive Phase 71 verify before milestone close.
...
**Goal:** Close the ITAM gap-closure backlog (originally `v4.1-ROADMAP.md`, superseded 2026-08-13 and folded in here as Phases 69–73): user management, core data/audit/customization, procurement workflow, reporting, and API/integrations.

**Status:** Code complete — pending REQUIREMENTS.md sync (ITAM-PRO-04/05) and a retroactive Phase 71 verify before milestone close.
