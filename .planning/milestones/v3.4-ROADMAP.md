...
- [x] 55-02-PLAN.md — AUT-03: deterministic anomaly branch in select_playbook() (shadow_ai_detected + agent_id → kill_process; else no_playbook); no new ACTION_MAP entry
