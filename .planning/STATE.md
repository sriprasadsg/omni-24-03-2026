...
status: planning-phase-50-complete
...
last_activity_desc: Phase 50 (Native Security Scanning) planned — 5 plans, 3 waves; agent-side yara-x scan engine + signed feed bundle. Next — /gsd-plan-phase 51 or execute 50.
progress:
  total_phases: 5
  completed_phases: 0
  total_plans: 0
