...
*No blocking-open threats. `threats_open` (gate field) = 0. Phase is not blocked from shipping under `block_on: high`. T-12 remains open/non-blocking and should still be tracked — see recommendation above.*
