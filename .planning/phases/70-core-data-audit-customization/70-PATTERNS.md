# Phase 70: Core Data, Audit & Customization - Pattern Map
...
**Apply to:** Every ITAM create/update/delete route touched by ITAM-DAT-02 (both new Phase 70 routes and the 7 backfilled existing files). Always wrap in `try/except Exception` that logs and does not fail the parent request.
