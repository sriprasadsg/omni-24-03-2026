...
- [x] **FOBS-01**: An admin can view an agent's CPU / memory / disk history as charts (consuming the existing `GET /agents/{id}/metrics/history` endpoint via the already-installed `recharts`).
