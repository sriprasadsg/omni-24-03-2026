...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/enterprise-omni-agent-ai-platform/.claude/.gsd-surface.json`
(sibling to `/home/user/enterprise-omni-agent-ai-platform/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/enterprise-omni-agent-ai-platform/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/enterprise-omni-agent-ai-platform/.claude/skills`).
...
`/home/user/enterprise-omni-agent-ai-platform/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/enterprise-omni-agent-ai-platform/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/enterprise-omni-agent-ai-platform/.claude/.gsd-surface.json`
Install profile marker: `/home/user/enterprise-omni-agent-ai-platform/.claude/.gsd-profile`
Skill dirs: `/home/user/enterprise-omni-agent-ai-platform/.claude/skills/gsd-*/`
Engine module: `/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
