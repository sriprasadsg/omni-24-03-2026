...
<execution_context>
@/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/enterprise-omni-agent-ai-platform/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
