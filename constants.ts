...
import { Permission, SubscriptionTier, TourStep } from './types';
...
export const GUIDED_TOUR_STEPS: TourStep[] = [
    {
        title: "Welcome to Omni-Agent AI!",
        text: "I'm Omni, your AI guide. Let me show you around the platform. Click 'Next' to begin!",
        position: 'center',
    },
    {
        targetElementId: 'sidebar-nav',
        title: "Navigation Sidebar",
        text: "This is your main navigation. All dashboards and features are grouped here for easy access.",
        position: 'right',
    },
    {
        title: "Tour Complete!",
        text: "This is just a brief overview. Feel free to explore the rest of the platform on your own!",
        position: 'center',
    },
];
