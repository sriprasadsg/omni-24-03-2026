...
const ABTestingDashboard = lazy(() => import('./components/ABTestingDashboard').then(m => ({ default: m.ABTestingDashboard || m.default || Object.values(m)[0] })));
const AccessReviewDashboard = lazy(() => import('./components/AccessReviewDashboard').then(m => ({ default: m.AccessReviewDashboard || m.default || Object.values(m)[0] })));
const AdvancedBiDashboard = lazy(() => import('./components/AdvancedBiDashboard').then(m => ({ default: m.AdvancedBiDashboard || m.default || Object.values(m)[0] })));
const AgentApprovalDashboard = lazy(() => import('./components/AgentApprovalDashboard').then(m => ({ default: m.AgentApprovalDashboard || m.default || Object.values(m)[0] })));
const AgentCapabilitiesDashboard = lazy(() => import('./components/AgentCapabilitiesDashboard').then(m => ({ default: m.AgentCapabilitiesDashboard || m.default || Object.values(m)[0] })));
const AgentsDashboard = lazy(() => import('./components/AgentsDashboard').then(m => ({ default: m.AgentsDashboard || m.default || Object.values(m)[0] })));
const AIAssistantChat = lazy(() => import('./components/AIAssistantChat').then(m => ({ default: m.AIAssistantChat || m.default || Object.values(m)[0] })));
const AIGovernanceDashboard = lazy(() => import('./components/AIGovernanceDashboard').then(m => ({ default: m.AIGovernanceDashboard || m.default || Object.values(m)[0] })));
const ApiExtensionsDashboard = lazy(() => import('./components/ApiExtensionsDashboard').then(m => ({ default: m.ApiExtensionsDashboard || m.default || Object.values(m)[0] })));
const APISecurityDashboard = lazy(() => import('./components/APISecurityDashboard').then(m => ({ default: m.APISecurityDashboard || m.default || Object.values(m)[0] })));
const ApiStatusDashboard = lazy(() => import('./components/ApiStatusDashboard').then(m => ({ default: m.ApiStatusDashboard || m.default || Object.values(m)[0] })));
const APMDashboard = lazy(() => import('./components/APMDashboard').then(m => ({ default: m.APMDashboard || m.default || Object.values(m)[0] })));
const ApprovalDashboard = lazy(() => import('./components/ApprovalDashboard').then(m => ({ default: m.ApprovalDashboard || m.default || Object.values(m)[0] })));
const AssetManagementDashboard = lazy(() => import('./components/AssetManagementDashboard').then(m => ({ default: m.AssetManagementDashboard || m.default || Object.values(m)[0] })));
const AttackPathDashboard = lazy(() => import('./components/AttackPathDashboard').then(m => ({ default: m.AttackPathDashboard || m.default || Object.values(m)[0] })));
const AuditLogDashboard = lazy(() => import('./components/AuditLogDashboard').then(m => ({ default: m.AuditLogDashboard || m.default || Object.values(m)[0] })));
const AuditProgramDashboard = lazy(() => import('./components/AuditProgramDashboard').then(m => ({ default: m.AuditProgramDashboard || m.default || Object.values(m)[0] })));
const AutomationPoliciesDashboard = lazy(() => import('./components/AutomationPoliciesDashboard').then(m => ({ default: m.AutomationPoliciesDashboard || m.default || Object.values(m)[0] })));
const AutoMLDashboard = lazy(() => import('./components/AutoMLDashboard').then(m => ({ default: m.AutoMLDashboard || m.default || Object.values(m)[0] })));
const ChaosEngineeringDashboard = lazy(() => import('./components/ChaosEngineeringDashboard').then(m => ({ default: m.ChaosEngineeringDashboard || m.default || Object.values(m)[0] })));
const CloudAccountsDashboard = lazy(() => import('./components/CloudAccountsDashboard').then(m => ({ default: m.CloudAccountsDashboard || m.default || Object.values(m)[0] })));
const CloudChecksScanner = lazy(() => import('./components/CloudChecksScanner').then(m => ({ default: m.CloudChecksScanner || m.default || Object.values(m)[0] })));
const CloudIntegrationsDashboard = lazy(() => import('./components/CloudIntegrationsDashboard').then(m => ({ default: m.CloudIntegrationsDashboard || m.default || Object.values(m)[0] })));
const CloudSecurityDashboard = lazy(() => import('./components/CloudSecurityDashboard').then(m => ({ default: m.CloudSecurityDashboard || m.default || Object.values(m)[0] })));
const CodeReviewGraphDashboard = lazy(() => import('./components/CodeReviewGraphDashboard').then(m => ({ default: m.CodeReviewGraphDashboard || m.default || Object.values(m)[0] })));
const ComplianceDashboard = lazy(() => import('./components/ComplianceDashboard').then(m => ({ default: m.ComplianceDashboard || m.default || Object.values(m)[0] })));
const CookieConsentDashboard = lazy(() => import('./components/CookieConsentDashboard').then(m => ({ default: m.CookieConsentDashboard || m.default || Object.values(m)[0] })));
const CorrelationDashboard = lazy(() => import('./components/CorrelationDashboard').then(m => ({ default: m.CorrelationDashboard || m.default || Object.values(m)[0] })));
const CustomFrameworkBuilder = lazy(() => import('./components/CustomFrameworkBuilder').then(m => ({ default: m.CustomFrameworkBuilder || m.default || Object.values(m)[0] })));
const CXODashboard = lazy(() => import('./components/CXODashboard').then(m => ({ default: m.CXODashboard || m.default || Object.values(m)[0] })));
const DAMDashboard = lazy(() => import('./components/DAMDashboard').then(m => ({ default: m.DAMDashboard || m.default || Object.values(m)[0] })));
const DASTDashboard = lazy(() => import('./components/DASTDashboard').then(m => ({ default: m.DASTDashboard || m.default || Object.values(m)[0] })));
const DataGovernanceDashboard = lazy(() => import('./components/DataGovernanceDashboard').then(m => ({ default: m.DataGovernanceDashboard || m.default || Object.values(m)[0] })));
const DataSecurityDashboard = lazy(() => import('./components/DataSecurityDashboard').then(m => ({ default: m.DataSecurityDashboard || m.default || Object.values(m)[0] })));
const DataUtilizationDashboard = lazy(() => import('./components/DataUtilizationDashboard').then(m => ({ default: m.DataUtilizationDashboard || m.default || Object.values(m)[0] })));
const DataWarehouseDashboard = lazy(() => import('./components/DataWarehouseDashboard').then(m => ({ default: m.DataWarehouseDashboard || m.default || Object.values(m)[0] })));
const DeceptionDashboard = lazy(() => import('./components/DeceptionDashboard').then(m => ({ default: m.DeceptionDashboard || m.default || Object.values(m)[0] })));
const DeveloperHubDashboard = lazy(() => import('./components/DeveloperHubDashboard').then(m => ({ default: m.DeveloperHubDashboard || m.default || Object.values(m)[0] })));
const DevSecOpsDashboard = lazy(() => import('./components/DevSecOpsDashboard').then(m => ({ default: m.DevSecOpsDashboard || m.default || Object.values(m)[0] })));
const DistributedTracingDashboard = lazy(() => import('./components/DistributedTracingDashboard').then(m => ({ default: m.DistributedTracingDashboard || m.default || Object.values(m)[0] })));
const DoraMetricsDashboard = lazy(() => import('./components/DoraMetricsDashboard').then(m => ({ default: m.DoraMetricsDashboard || m.default || Object.values(m)[0] })));
const EDRDashboard = lazy(() => import('./components/EDRDashboard').then(m => ({ default: m.EDRDashboard || m.default || Object.values(m)[0] })));
const EmailSecurityDashboard = lazy(() => import('./components/EmailSecurityDashboard').then(m => ({ default: m.EmailSecurityDashboard || m.default || Object.values(m)[0] })));
const ExecutiveDashboard = lazy(() => import('./components/ExecutiveDashboard').then(m => ({ default: m.ExecutiveDashboard || m.default || Object.values(m)[0] })));
const FinOpsBillingPage = lazy(() => import('./components/FinOpsBillingPage').then(m => ({ default: m.FinOpsBillingPage || m.default || Object.values(m)[0] })));
const FleetGeoMap = lazy(() => import('./components/FleetGeoMap').then(m => ({ default: m.FleetGeoMap || m.default || Object.values(m)[0] })));
const FleetObservabilityDashboard = lazy(() => import('./components/FleetObservabilityDashboard').then(m => ({ default: m.FleetObservabilityDashboard || m.default || Object.values(m)[0] })));
const FutureTechDashboard = lazy(() => import('./components/FutureTechDashboard').then(m => ({ default: m.FutureTechDashboard || m.default || Object.values(m)[0] })));
const GovernanceDocumentsDashboard = lazy(() => import('./components/GovernanceDocumentsDashboard').then(m => ({ default: m.GovernanceDocumentsDashboard || m.default || Object.values(m)[0] })));
const HADRDashboard = lazy(() => import('./components/HADRDashboard').then(m => ({ default: m.HADRDashboard || m.default || Object.values(m)[0] })));
const IacContainerDashboard = lazy(() => import('./components/IacContainerDashboard').then(m => ({ default: m.IacContainerDashboard || m.default || Object.values(m)[0] })));
const InboundQuestionnaireDashboard = lazy(() => import('./components/InboundQuestionnaireDashboard').then(m => ({ default: m.InboundQuestionnaireDashboard || m.default || Object.values(m)[0] })));
const IncidentImpactDashboard = lazy(() => import('./components/IncidentImpactDashboard').then(m => ({ default: m.IncidentImpactDashboard || m.default || Object.values(m)[0] })));
const IncidentResponseDashboard = lazy(() => import('./components/IncidentResponseDashboard').then(m => ({ default: m.IncidentResponseDashboard || m.default || Object.values(m)[0] })));
const IncidentWarRoomDashboard = lazy(() => import('./components/IncidentWarRoomDashboard').then(m => ({ default: m.IncidentWarRoomDashboard || m.default || Object.values(m)[0] })));
const InsiderThreatDashboard = lazy(() => import('./components/InsiderThreatDashboard').then(m => ({ default: m.InsiderThreatDashboard || m.default || Object.values(m)[0] })));
const InvoiceList = lazy(() => import('./components/InvoiceList').then(m => ({ default: m.InvoiceList || m.default || Object.values(m)[0] })));
const ITAMConsole = lazy(() => import('./components/itam/ITAMConsole').then(m => ({ default: m.ITAMConsole || m.default || Object.values(m)[0] })));
const JITAccessDashboard = lazy(() => import('./components/JITAccessDashboard').then(m => ({ default: m.JITAccessDashboard || m.default || Object.values(m)[0] })));
const K8sSecurityDashboard = lazy(() => import('./components/K8sSecurityDashboard').then(m => ({ default: m.K8sSecurityDashboard || m.default || Object.values(m)[0] })));
const KnowledgeBaseDashboard = lazy(() => import('./components/KnowledgeBaseDashboard').then(m => ({ default: m.KnowledgeBaseDashboard || m.default || Object.values(m)[0] })));
const LogExplorerDashboard = lazy(() => import('./components/LogExplorerDashboard').then(m => ({ default: m.LogExplorerDashboard || m.default || Object.values(m)[0] })));
const MaturityScoreDashboard = lazy(() => import('./components/MaturityScoreDashboard').then(m => ({ default: m.MaturityScoreDashboard || m.default || Object.values(m)[0] })));
const MDRDashboard = lazy(() => import('./components/MDRDashboard').then(m => ({ default: m.MDRDashboard || m.default || Object.values(m)[0] })));
const MLOpsDashboard = lazy(() => import('./components/MLOpsDashboard').then(m => ({ default: m.MLOpsDashboard || m.default || Object.values(m)[0] })));
const ModelMonitoringDashboard = lazy(() => import('./components/ModelMonitoringDashboard').then(m => ({ default: m.ModelMonitoringDashboard || m.default || Object.values(m)[0] })));
const NativeSecurityConsole = lazy(() => import('./components/NativeSecurityConsole').then(m => ({ default: m.NativeSecurityConsole || m.default || Object.values(m)[0] })));
const NDRDashboard = lazy(() => import('./components/NDRDashboard').then(m => ({ default: m.NDRDashboard || m.default || Object.values(m)[0] })));
const NetworkObservabilityDashboard = lazy(() => import('./components/NetworkObservabilityDashboard').then(m => ({ default: m.NetworkObservabilityDashboard || m.default || Object.values(m)[0] })));
const NetworkTopologyMap = lazy(() => import('./components/NetworkTopologyMap').then(m => ({ default: m.NetworkTopologyMap || m.default || Object.values(m)[0] })));
const NotificationsDashboard = lazy(() => import('./components/NotificationsDashboard').then(m => ({ default: m.NotificationsDashboard || m.default || Object.values(m)[0] })));
const PatchManagementDashboard = lazy(() => import('./components/PatchManagementDashboard').then(m => ({ default: m.PatchManagementDashboard || m.default || Object.values(m)[0] })));
const PaymentSettings = lazy(() => import('./components/PaymentSettings').then(m => ({ default: m.PaymentSettings || m.default || Object.values(m)[0] })));
const PentestDashboard = lazy(() => import('./components/PentestDashboard').then(m => ({ default: m.PentestDashboard || m.default || Object.values(m)[0] })));
const PlaybookBuilder = lazy(() => import('./components/PlaybookBuilder').then(m => ({ default: m.PlaybookBuilder || m.default || Object.values(m)[0] })));
const PrivacyDashboard = lazy(() => import('./components/PrivacyDashboard').then(m => ({ default: m.PrivacyDashboard || m.default || Object.values(m)[0] })));
const PrivacyLegalDashboard = lazy(() => import('./components/PrivacyLegalDashboard').then(m => ({ default: m.PrivacyLegalDashboard || m.default || Object.values(m)[0] })));
const ProactiveInsightsDashboard = lazy(() => import('./components/ProactiveInsightsDashboard').then(m => ({ default: m.ProactiveInsightsDashboard || m.default || Object.values(m)[0] })));
const ProgramsDashboard = lazy(() => import('./components/ProgramsDashboard').then(m => ({ default: m.ProgramsDashboard || m.default || Object.values(m)[0] })));
const ReportingDashboard = lazy(() => import('./components/ReportingDashboard').then(m => ({ default: m.ReportingDashboard || m.default || Object.values(m)[0] })));
const RetentionPolicyDashboard = lazy(() => import('./components/RetentionPolicyDashboard').then(m => ({ default: m.RetentionPolicyDashboard || m.default || Object.values(m)[0] })));
const RiskRegister = lazy(() => import('./components/RiskRegister').then(m => ({ default: m.RiskRegister || m.default || Object.values(m)[0] })));
const SaaSIntegrationsDashboard = lazy(() => import('./components/SaaSIntegrationsDashboard').then(m => ({ default: m.SaaSIntegrationsDashboard || m.default || Object.values(m)[0] })));
const ScheduledReportsDashboard = lazy(() => import('./components/ScheduledReportsDashboard').then(m => ({ default: m.ScheduledReportsDashboard || m.default || Object.values(m)[0] })));
const SecretsManagementDashboard = lazy(() => import('./components/SecretsManagementDashboard').then(m => ({ default: m.SecretsManagementDashboard || m.default || Object.values(m)[0] })));
const SecureFileShare = lazy(() => import('./components/SecureFileShare').then(m => ({ default: m.SecureFileShare || m.default || Object.values(m)[0] })));
const SecurityAuditDashboard = lazy(() => import('./components/SecurityAuditDashboard').then(m => ({ default: m.SecurityAuditDashboard || m.default || Object.values(m)[0] })));
const SecurityDashboard = lazy(() => import('./components/SecurityDashboard').then(m => ({ default: m.SecurityDashboard || m.default || Object.values(m)[0] })));
const SecuritySettingsDashboard = lazy(() => import('./components/SecuritySettingsDashboard').then(m => ({ default: m.SecuritySettingsDashboard || m.default || Object.values(m)[0] })));
const SecurityTraining = lazy(() => import('./components/SecurityTraining').then(m => ({ default: m.SecurityTraining || m.default || Object.values(m)[0] })));
const ServiceCatalogDashboard = lazy(() => import('./components/ServiceCatalogDashboard').then(m => ({ default: m.ServiceCatalogDashboard || m.default || Object.values(m)[0] })));
const ServiceMeshDashboard = lazy(() => import('./components/ServiceMeshDashboard').then(m => ({ default: m.ServiceMeshDashboard || m.default || Object.values(m)[0] })));
const ServicePricingPage = lazy(() => import('./components/ServicePricingPage').then(m => ({ default: m.ServicePricingPage || m.default || Object.values(m)[0] })));
const SettingsDashboard = lazy(() => import('./components/SettingsDashboard').then(m => ({ default: m.SettingsDashboard || m.default || Object.values(m)[0] })));
const ShadowAI = lazy(() => import('./components/ShadowAI').then(m => ({ default: m.ShadowAI || m.default || Object.values(m)[0] })));
const SiemRulesDashboard = lazy(() => import('./components/SiemRulesDashboard').then(m => ({ default: m.SiemRulesDashboard || m.default || Object.values(m)[0] })));
const SOARDashboard = lazy(() => import('./components/SOARDashboard').then(m => ({ default: m.SOARDashboard || m.default || Object.values(m)[0] })));
const SoftwareUpdateManagement = lazy(() => import('./components/SoftwareUpdateManagement').then(m => ({ default: m.SoftwareUpdateManagement || m.default || Object.values(m)[0] })));
const StreamingDashboard = lazy(() => import('./components/StreamingDashboard').then(m => ({ default: m.StreamingDashboard || m.default || Object.values(m)[0] })));
