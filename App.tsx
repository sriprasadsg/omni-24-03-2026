...
const SubscriptionManagement = lazy(() => import('./components/SubscriptionManagement').then(m => ({ default: m.default })));
const SupplyChainDashboard = lazy(() => import('./components/SupplyChainDashboard').then(m => ({ default: m.default })));
...
const ThreatDashboard = lazy(() => import('./components/ThreatDashboard').then(m => ({ default: m.default })));
const ThreatHuntingDashboard = lazy(() => import('./components/ThreatHuntingDashboard').then(m => ({ default: m.ThreatHuntingDashboard })));
const TrustCenter = lazy(() => import('./components/TrustCenter').then(m => ({ default: m.default })));
const TrustPage = lazy(() => import('./components/TrustPage').then(m => ({ default: m.default })));
...
const VendorManagement = lazy(() => import('./components/VendorManagement').then(m => ({ default: m.default })));
const VulnerabilityManagement = lazy(() => import('./components/VulnerabilityManagement').then(m => ({ default: m.default })));
...
const ZeroTrustQuantumDashboard = lazy(() => import('./components/ZeroTrustQuantumDashboard').then(m => ({ default: m.default })));
...
const SimulationDashboard = lazy(() => import('./components/SimulationDashboard').then(m => ({ default: m.default })));
const CISSPOracle = lazy(() => import('./components/CISSPOracle').then(m => ({ default: m.default })));
...
const LLMOpsDashboard = lazy(() => import('./components/LLMOpsDashboard').then(m => ({ default: m.default })));
...
const ActiveResponseDashboard = lazy(() => import('./components/ActiveResponseDashboard').then(m => ({ default: m.default })));
const AdvancedHuntingDashboard = lazy(() => import('./components/AdvancedHuntingDashboard').then(m => ({ default: m.default })));
const AgentGroupsDashboard = lazy(() => import('./components/AgentGroupsDashboard').then(m => ({ default: m.default })));
...
const AndroidEnterpriseDashboard = lazy(() => import('./components/AndroidEnterpriseDashboard').then(m => ({ default: m.default })));
const AppCatalogDashboard = lazy(() => import('./components/AppCatalogDashboard').then(m => ({ default: m.default })));
const AssetIntelligenceDashboard = lazy(() => import('./components/AssetIntelligenceDashboard').then(m => ({ default: m.default })));
const AttackTimelineDashboard = lazy(() => import('./components/AttackTimelineDashboard').then(m => ({ default: m.default })));
const AutopilotDashboard = lazy(() => import('./components/AutopilotDashboard').then(m => ({ default: m.default })));
const BAAManagement = lazy(() => import('./components/BAAManagement').then(m => ({ default: m.BAAManagement || m.default || Object.values(m)[0] })));
const BranchSitesDashboard = lazy(() => import('./components/BranchSitesDashboard').then(m => ({ default: m.default })));
...
const ChangeManagementDashboard = lazy(() => import('./components/ChangeManagementDashboard').then(m => ({ default: m.default })));
const CharacterTourBot = lazy(() => import('./components/CharacterTourBot').then(m => ({ default: m.CharacterTourBot })));
const ChatHub = lazy(() => import('./components/ChatHub').then(m => ({ default: m.default })));
...
const ConditionalAccessDashboard = lazy(() => import('./components/ConditionalAccessDashboard').then(m => ({ default: m.default })));
const ConfigDriftDashboard = lazy(() => import('./components/ConfigDriftDashboard').then(m => ({ default: m.default })));
const ConnectorsHubDashboard = lazy(() => import('./components/ConnectorsHubDashboard').then(m => ({ default: m.default })));
...
const DetectionRulesDashboard = lazy(() => import('./components/DetectionRulesDashboard').then(m => ({ default: m.default })));
const DeviceConfigProfilesDashboard = lazy(() => import('./components/DeviceConfigProfilesDashboard').then(m => ({ default: m.default })));
const DLPDashboard = lazy(() => import('./components/DLPDashboard').then(m => ({ default: m.default })));
const FimAlertsDashboard = lazy(() => import('./components/FimAlertsPanel').then(m => ({ default: m.FimAlertsPanel })));
const FIMDashboard = lazy(() => import('./components/FIMDashboard').then(m => ({ default: m.default })));
const FirmwareDriverDashboard = lazy(() => import('./components/FirmwareDriverDashboard').then(m => ({ default: m.default })));
const GeographicAttackMap = lazy(() => import('./components/GeographicAttackMap').then(m => ({ default: m.default })));
const GoalSystemDashboard = lazy(() => import('./components/GoalSystemDashboard').then(m => ({ default: m.GoalSystemDashboard })));
...
const InteractiveVoiceBot = lazy(() => import('./components/InteractiveVoiceBot').then(m => ({ default: m.InteractiveVoiceBot })));
const InternalTicketsDashboard = lazy(() => import('./components/InternalTicketsDashboard').then(m => ({ default: m.default })));
const MAMDashboard = lazy(() => import('./components/MAMDashboard').then(m => ({ default: m.default })));
const MitreAttackHeatmap = lazy(() => import('./components/MitreAttackHeatmap').then(m => ({ default: m.default })));
const MobileDashboard = lazy(() => import('./components/MobileDashboard').then(m => ({ default: m.default })));
const MSSPDashboard = lazy(() => import('./components/MSSPDashboard').then(m => ({ default: m.default })));
...
const NotificationPreferencesDashboard = lazy(() => import('./components/NotificationPreferencesDashboard').then(m => ({ default: m.default })));
...
const PredictiveHealthDashboard = lazy(() => import('./components/PredictiveHealthDashboard').then(m => ({ default: m.PredictiveHealthDashboard })));
const ProblemManagementDashboard = lazy(() => import('./components/ProblemManagementDashboard').then(m => ({ default: m.default })));
...
const RetentionPoliciesDashboard = lazy(() => import('./components/RetentionPoliciesDashboard').then(m => ({ default: m.default })));
...
const RuntimeSecurityDashboard = lazy(() => import('./components/RuntimeSecurityTab').then(m => ({ default: m.RuntimeSecurityTab })));
const SASTDashboardLazy = lazy(() => import('./components/SASTDashboard').then(m => ({ default: m.SASTDashboard })));
const SCADashboard = lazy(() => import('./components/SCADashboard').then(m => ({ default: m.default })));
const SecurityCopilotDashboard = lazy(() => import('./components/SecurityCopilotDashboard').then(m => ({ default: m.default })));
const TicketingIntegration = lazy(() => import('./components/TicketingIntegration').then(m => ({ default: m.default })));
const TicketWebhooksDashboard = lazy(() => import('./components/TicketWebhooksDashboard').then(m => ({ default: m.default })));
const YaraRuleEditor = lazy(() => import('./components/YaraRuleEditor').then(m => ({ default: m.YaraRuleEditor })));
const BundleManagementDashboard = lazy(() => import('./components/BundleManagementDashboard').then(m => ({ default: m.default })));
const SwarmDashboard = lazy(() => import('./components/SwarmDashboard').then(m => ({ default: m.default })));
