...
@router.get("/models")
async def get_models(current_user: dict = Depends(require_permission("view:ai_systems"))):
    """Get Model Registry."""
...
@router.get("/history")
async def get_history(current_user: dict = Depends(require_permission("view:ai_systems"))):
